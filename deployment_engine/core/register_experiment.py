#!/usr/bin/env python3
"""Register a deployment in PHASE experiments.json.
...
def main():
    parser = argparse.ArgumentParser(
        description="Register a deployment in PHASE experiments.json"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "the DECOY neighborhood sidecar VM which lives in a separate inventory "
    ...
    # happened 2026-04-17: a batch of rampart + decoy deploys interleaved
    ...
    # /mnt/AXES2U1 NFS mount blipped and silently discarded ghosts+decoy
