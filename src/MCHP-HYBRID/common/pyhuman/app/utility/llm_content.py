...
LLM-powered content generation abstraction layer for MCHP-HYBRID agents.
...
Usage:
    from app.utility.llm_content import llm_paragraph, llm_sentence, llm_search_query
...
# Add common module to path for logging
